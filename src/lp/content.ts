...
export const OPERATOR = {
  brand: 'CATENARIA',
  origin:
    '「カテナリー」は、鎖が自重で垂れるときに描く曲線の名前です。アントニ・ガウディが、自然の摂理から導かれるこの形を建築の構造に応用しました。CATENARIAは、ガウディが生まれ育ったスペイン・カタルーニャ地方でこの曲線を指す言葉です。お客さまをしっかりと支える存在でありたいという思いを、屋号に込めました。',
